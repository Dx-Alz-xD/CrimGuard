...
(() => {
  ...
  async function refresh() {
    ...
    // The response carries the real shares too; those are the dashboard's own panel to draw.
    render(Array.isArray(data.files) ? data.files.filter((file) => 'fileName' in file) : []);
  }
